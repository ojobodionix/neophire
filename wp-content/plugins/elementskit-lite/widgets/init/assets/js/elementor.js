!(function (e, t) {
        ...
        e.ajax({
          ...
          beforeSend: function () {
            t.addClass("ekit-ajax-loading"),
              n.replaceWith(
                '<span class="elementskit-submenu-indicator ekit-spinner"></span>'
              ),
          ...
          success: function (n) {
            t.removeClass("ekit-ajax-loading"),
              i.replaceWith(n),
              t
                .find(".elementskit-submenu-indicator.ekit-spinner")
                .replaceWith(o),
  ...
  let n = {
    ...
    Video: function (t) {
          ...
          callbacks: {
            elementParse: function (n) {
              ...
              if (i && "self" === i.videoTypeName && "popup" === i.videoStyle) {
                ...
                t.length &&
                  (i.autoplay &&
                    (t.prop("autoplay", !0).attr("autoplay"), t[0].play()),
      ...
      var a,
        l = t.find(".ekit-inline-video-content"),
        r = l.find(".ekit-video-inline-btn");
      l.find(".ekit-inline-video-overlay-image").length > 0 &&
        r.length > 0 &&
        r.on("click", function (n) {
          if (
            ...
            ("youtube" === o.videoTypeName || "vimeo" === o.videoTypeName) &&
            "inline" === o.videoStyle &&
            o.autoplay
          ) {
          ...
          i
            .find(".ekit-inline-video-overlay-image, .ekit-video-inline-btn")
            .hide(),
